...
import raft.core.node.store.AbstractTaskExecutor;
...
public class DirectTaskExecutor extends AbstractTaskExecutor {
    ...
    public DirectTaskExecutor() { this.throwWhenFailed = false; }

    public DirectTaskExecutor(boolean throwWhenFailed) { this.throwWhenFailed = throwWhenFailed; }
