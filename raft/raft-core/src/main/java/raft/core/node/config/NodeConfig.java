...
public class NodeConfig {
     ...
     */
    private int minElectionTimeout = 10000;

    /**
     * Maximum election timeout
     */
    private int maxElectionTimeout = 15000;

    /**
     * Delay for first log replication after becoming leader
     */
    private int logReplicationDelay = 1000;
     ...
     */
    private int nioWorkerThreads = 3;
